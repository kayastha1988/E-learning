...
public interface IInstructorService {
	...
	ArrayList<Course> retrieveCoursesByUsername(String userName)
	...
	ArrayList<Course> retrieveCourseByName(String courseName)
			throws InstructorException;

	ArrayList<String> getContentById(int courseId) throws InstructorException;

	void setContentbyId(int courseId, InputStream inputStream, String filename)
			throws InstructorException;

	ArrayList<Assignment> getAssignmentById(int courseId)
			throws InstructorException;

	void setAssignmentById(int courseId, Assignment assignment)
			throws InstructorException;
	...
	void setInfoById(int courseId, String information)
			throws InstructorException;
	...
	InputStream downloadContentByName(String fileName)
			throws InstructorException;

	String extractFileName(Part part) throws InstructorException;

	TreeMap<String, GradeCenter> getGrades(int courseId)
			throws InstructorException;

	TreeMap<String, GradeCenter> getGradesInDescending(int courseId)
			throws InstructorException;
